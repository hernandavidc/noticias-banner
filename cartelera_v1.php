                ...
                function change() {
                    ...
                    if (imagenes && imagenes != "") {
                        ...
                        for (var multimediaIter = 0; multimediaIter < imagenes.length; multimediaIter++) {
                            var imageUrl = <?php echo '"https:////admon.bionix.com.co//recursos//uresidencial'.htmlspecialchars($_GET["res"]).'//anuncios//anuncio"'; ?> + dataArray[counter].idanuncio + '//images//' + imagenes[multimediaIter].url;
                            if (multimediaIter != 0) {
                        ...
                        let imageUrl = 'https://bionix.com.co/admon_signaged/default_banner.jpg';
